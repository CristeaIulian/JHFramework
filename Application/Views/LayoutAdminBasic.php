...
<html lang="en-us">	
	...
	<body>
		...
		<script type="text/javascript" src="<?php echo Core\Config::get('path.web'); ?>Assets/Js/jquery-2.1.1.min.js"></script>'
		<script type="text/javascript" src="<?php echo Core\Config::get('path.web'); ?>Assets/Js/jquery-ui-1.10.3.min.js"></script>
