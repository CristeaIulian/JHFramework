...
<html lang="en-us">	
	<head>
		...
		<link rel="stylesheet" type="text/css" media="screen" href="<?php echo Core\Config::get('path.web'); ?>Assets/Css/bootstrap.min.css">
		<link rel="stylesheet" type="text/css" media="screen" href="<?php echo Core\Config::get('path.web'); ?>Assets/Css/font-awesome.min.css">
	...
	<body>
		...
		<script type="text/javascript" src="<?php echo Core\Config::get('path.web'); ?>Assets/Js/jquery-3.7.1.min.js"></script>
		<script type="text/javascript" src="<?php echo Core\Config::get('path.web'); ?>Assets/Js/jquery-ui-1.13.3.custom/jquery-ui.min.j"></script>
		<script type="text/javascript" src="<?php echo Core\Config::get('path.web'); ?>Assets/Js/bootstrap.min.js"></script>
